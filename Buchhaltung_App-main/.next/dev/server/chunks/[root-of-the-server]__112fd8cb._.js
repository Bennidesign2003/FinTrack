...
"[project]/pages/api/expenses-trend.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        ...
        const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["db"].select({
            month: __TURBOPACK__imported__module__$5b$externals$5d2f$drizzle$2d$orm__$5b$external$5d$__$28$drizzle$2d$orm$2c$__esm_import$29$__["sql"]`strftime('%Y-%m', ${__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["expenses"].createdAt})`,
        ...
        }).from(__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["expenses"]).groupBy(__TURBOPACK__imported__module__$5b$externals$5d2f$drizzle$2d$orm__$5b$external$5d$__$28$drizzle$2d$orm$2c$__esm_import$29$__["sql"]`strftime('%Y-%m', ${__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["expenses"].createdAt})`).all();
        ...
        return res.status(500).json({
            error: 'Fehler beim Abrufen der Ausgabedaten',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__112fd8cb._.js.map