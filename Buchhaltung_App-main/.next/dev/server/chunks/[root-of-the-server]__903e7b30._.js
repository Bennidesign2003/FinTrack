    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            if (!id || !customer || Number.isNaN(amount)) {
                return res.status(400).json({
                    error: 'id, customer und amount sind erforderlich'
                });
            }
            const taxAmount = +(amount * (taxRate / 100));
            const totalAmount = +(amount + taxAmount);
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["db"].update(__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["invoices"]).set({
                customer,
                title: title || `Rechnung ${new Date().getFullYear()}-${Math.random().toString(36).slice(2, 7)}`,
                amount,
                taxRate,
                ...
                status: status === 'paid' || status === 'overdue' ? status : 'open'
            }).where((0, __TURBOPACK__imported__module__$5b$externals$5d2f$drizzle$2d$orm__$5b$external$5d$__$28$drizzle$2d$orm$2c$__esm_import$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["invoices"].id, Number(id))).returning();
            const normalizedInvoice = {
                ...updated[0],
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["db"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["invoices"]).where((0, __TURBOPACK__imported__module__$5b$externals$5d2f$drizzle$2d$orm__$5b$external$5d$__$28$drizzle$2d$orm$2c$__esm_import$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$db$2f$schema$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["invoices"].id, Number(id))).run();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__903e7b30._.js.map